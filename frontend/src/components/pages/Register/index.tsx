    ...
    <>
      <div style={Styles.container}>
          <div style={Styles.loginForm}>
              ...
              <span style={Styles.span}>ニックネーム</span>
              
              <input type="password" id="password" placeholder="ニックネーム" style={Styles.input} />

              <div style={Styles.loginButtons}>
                  <button style={{ ...Styles.button, ...Styles.secondary }} onClick={handleSignin} >ログインページへ</button>
                  <button style={{ ...Styles.button, ...Styles.primary }} onClick={handleRegister} >新規登録</button>
              </div>
          </div>
      </div>
    </>
